    ...
    <div>
      <div className="flex justify-center font-wondar">
        <div className="w-full lg:w-2/6 bg-slate-200 h-screen bg-cover bg-center text-white" style={{backgroundImage: `url(${home})` }}>
          <div className="text-center pt-10">
            ...
            <div className="font-amsterdam text-4xl mt-5">Pony & Hendi</div>
      ...
      <div className="flex justify-center font-wondar">
        <div className="w-full lg:w-2/6 h-screen bg-slate-800 text-white px-10 pt-10 text-center space-y-10">
          <div>
            <div className="text-3xl underline font-semibold">Akad Nikah</div>
            <div className="grid grid-cols-1 text-xl mt-7">
              <div>Minggu</div>
          ...
          <div>
            <div className="text-3xl underline font-semibold">Resepsi Nikah</div>
            <div className="grid grid-cols-1 text-xl mt-7">
              <div>Minggu</div>
              <div className="text-3xl">19</div>
              <div>Februari 2023</div>
              ...
              <a href='https://goo.gl/maps/nT3UVpquQAj258cUA' target="_blank" className="border border-white py-2 px-4 rounded hover:border-black hover:bg-white hover:text-black font-bold mt-10">
                Open maps
              </a>
            </div>
          </div>
      ...
      <div className="flex justify-center font-wondar">
        <div className="w-full lg:w-2/6 h-screen bg-slate-200 text-black px-10 pt-10 text-center space-y-10">
          <div className="text-2xl">WEDDING <span className="font-amsterdam">Gift</span> </div>
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="flex bg-slate-800 text-white justify-between px-2 items-center py-4 rounded">
              <div>
          ...
          <div className="flex bg-slate-800 text-white justify-between px-6 space-x-5 items-center py-4 rounded">
              <div className="text-left">
                Jl. Bakti VI RT 001 RW 08 No. 30, Kelurahan Gaga, Kecamatan Larangan
              </div>
              <div className="w-1/6 flex justify-center">
